...
class ExcelInterface:
    ...
    def rows_to_dict(self, rows):
        ...
        import numpy as np
        import pdb
        for row_num in np.arange(rows[0], rows[1] + 1, 1):
            row_data = []
            key = None
...
if __name__ == '__main__':
    import numpy as np
    file_path = './scripts/ArbitraryTestbench.xlsx'
    ...
    get_rows = excel_interface.get_rows_between_keyword_and_empty("Waveforms")
