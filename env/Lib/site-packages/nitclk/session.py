...
class _Session(object):
    ...
    def configure_for_homogeneous_triggers(self, sessions):
        ...
        return 0 , sessions
    """
    Update By Andrew Bechdolt 6/21/2024
    """
    def convert_sessions_to_session_number_list(self,sessions):
        r'''convert_to_nitclk_session_number_list

        Converts the sessions to a list of session numbers.

        Args:
            sessions (list of instrument-specific sessions or nitclk.SessionReference instances): sessions is an array of sessions that are being synchronized.

        Returns:
            session_numbers (list of int): The session numbers that are being synchronized.

        '''

        session_numbers = _converters.convert_to_nitclk_session_number_list(sessions)
...
Update By Andrew Bechdolt 6/21/2024
"""
def convert_sessions_to_session_number_list(sessions):
    r'''convert_to_nitclk_session_number_list
    ...
    '''
    return _Session().convert_to_nitclk_session_number_list(sessions)  
"""
End Update    
"""
