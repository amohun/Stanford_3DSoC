...
class LibraryInterpreter(object):
    ...
    * Converting errors returned by Library into Python exceptions.
    ...
    """
    def burst_pattern_synchronized(self, sessions, site_list,start_label,select_digital_function,wait_until_done,timeout):
        ...
        wait_until_done_ctype = _visatype.ViBoolean(wait_until_done)  # case S150
        timeout_ctype = _visatype.ViReal64(timeout)  # case S150
        error_code = self._library.niDigital_BurstPatternSynchronized(session_count_ctype, sessions_ctype, site_list_ctype, start_label_ctype, select_digital_function_ctype, wait_until_done_ctype, timeout_ctype)
        errors.handle_error(self, error_code, ignore_warnings=False, is_error_handling=False)
    """
    End Changes
    """
