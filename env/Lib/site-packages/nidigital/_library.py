...
class Library(object):
    ...
    def __init__(self, ctypes_library):
        ...
        self.niDigital_BurstPatternSynchronized_cfunc = None
    ...
    def niDigital_BurstPatternSynchronized(self, session_count, vi, site_list, start_label, select_digital_function, wait_until_done, timeout):  # noqa: N802
        with self._func_lock:
            if self.niDigital_BurstPatternSynchronized_cfunc is None:
                self.niDigital_BurstPatternSynchronized_cfunc = self._get_library_function('niDigital_BurstPatternSynchronized')
                self.niDigital_BurstPatternSynchronized_cfunc.argtypes = [ViUInt32, ctypes.POINTER(ViSession), ctypes.POINTER(ViChar), ctypes.POINTER(ViChar), ViBoolean, ViBoolean, ViReal64]  # noqa: F405
                self.niDigital_BurstPatternSynchronized_cfunc.restype = ViStatus  # noqa: F405
        return self.niDigital_BurstPatternSynchronized_cfunc(session_count, vi, site_list, start_label, select_digital_function, wait_until_done, timeout)
