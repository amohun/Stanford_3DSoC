...
class _SessionBase(object):
    ...
    """
    Changes by Andrew Bechdolt 6-20-2024
    """
    def _burst_pattern_synchronized(self, sessions, start_label, select_digital_function=True, wait_until_done=True, timeout=hightime.timedelta(seconds=10.0)):
        r'''_burst_pattern_synchronized
        Uses the **startLabel** you specify to burst the pattern on the sites you specify and provides the option to wait for the burst to complete. Digital pins retain their state at the end of a pattern burst until the first vector of a subsequent pattern burst, a call to write_static, or a call to apply_levels_and_timing.
        ...
        Args:
            sessions (list): List of sessions to burst the pattern on.
        ...
        '''
        timeout = _converters.convert_timedelta_to_seconds_real64(timeout)
        self._interpreter.burst_pattern_synchronized(sessions, self._repeated_capability, start_label, select_digital_function, wait_until_done, timeout)
    ...
    """
    Begin Andrew Bechdolt Changes 6-20-2024
    """
    @ivi_synchronized
    def burst_pattern_synchronized(self,sessions,start_label, select_digital_function=True,wait_until_done=True,timeout=hightime.timedelta(seconds=10.0)):
        '''burst_pattern_synchronized

        Uses the start_label you specify to burst the pattern on the sites you specify across multiple sites
        If you specify wait_until_done as True, waits for the burst to complete, and returns comparison results for each site.
        ...
        Args:
            sessiojns (list of nidigital.Session): List of session objects to burst the pattern on.
        ...
        '''
        self._burst_pattern_synchronized(sessions, start_label, select_digital_function, wait_until_done, timeout)
